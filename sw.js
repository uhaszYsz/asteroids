...
const MANIFEST_URLS = (repo, ref) => ([
  `https://cdn.jsdelivr.net/gh/${repo}@${ref}/asset-manifest.json`,
  `https://raw.githubusercontent.com/${repo}/${ref}/asset-manifest.json`,
  './asset-manifest.json'
]);
...
function cdnUrls(rel, repo, ref) {
  ...
  return [
    `https://cdn.jsdelivr.net/gh/${repo}@${ref}/${enc}`,
    `https://raw.githubusercontent.com/${repo}/${ref}/${enc}`
  ];
}
